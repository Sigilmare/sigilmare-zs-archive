...
if CLIENT then
	...
	SWEP.ViewModelFOV = ZS.VMFOVScale * 55

	SWEP.VElements = {
		["element_name"] = { type = "Model", model = "models/weapons/cstrike/c_knife_t.mdl", bone = "r_hand_weap", rel = "", pos = Vector(27.701, -9.157, 10.811), angle = Angle(-143.75999, -29.272, -77.215), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
end
...
SWEP.ViewModel = "models/weapons/sigilmare/zs/c_knife.mdl"
