...
if CLIENT then
	...
	SWEP.VElements = {
		["element_name"] = { type = "Model", model = "models/props_junk/harpoon002a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.856, 1.876, 30), angle = Angle(89.4, -90, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}	
	SWEP.WElements = {
...
SWEP.ViewModel = "models/weapons/sigilmare/zs/c_harpoon.mdl"
