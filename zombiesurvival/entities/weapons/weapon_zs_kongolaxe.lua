...
if CLIENT then
	SWEP.ViewModelFOV = ZS.VMFOVScale * 65
	...
	SWEP.VElements = {
		...
		["base"] = { type = "Model", model = "models/props/cs_militia/axe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.75, 0), angle = Angle(0, -10, 87), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
