...
function GM:AddSkill(id, name, description, x, y, connections, tree, prestige)
...
SKILLMOD_LOW_HEALTH_SLOW_MUL = 85
...
SKILLMOD_ARMOR = 97
SKILLMOD_ARMOR_GAIN_MUL = 98
SKILLMOD_MELEE_DAMAGE_TO_ARMOR_MUL = 99
...
GM:AddSkill(SKILL_STOIC5, "Stoic V", GOOD.."+7 maximum health\n"..BAD.."-5.25 movement speed",
																-3,			2,					{SKILL_ARMOR, SKILL_TANKER}, TREE_HEALTHTREE)
GM:AddSkill(SKILL_D_HEMOPHILIA, "Debuff: Hemophilia", GOOD.."+10 starting Worth\n"..GOOD.."+3 starting scrap\n"..BAD.."Bleed for 25% extra damage when hit",
																4,			2,					{}, TREE_HEALTHTREE)
GM:AddSkill(SKILL_GLUTTON, "Glutton", GOOD.."Gain up to 30 armor when you eat food\n"..GOOD.."Armor gained can exceed the cap by 40\n"..BAD.."-5 maximum health\n"..BAD.."No longer receive health from eating food",
																3,			-2,					{SKILL_GOURMET, SKILL_ARMOR}, TREE_HEALTHTREE)
...
GM:AddSkill(SKILL_HAEMOSTASIS, "Haemostasis", GOOD.."Resist status effects while you have at least 10 armor\n"..BAD.."Lose 10 armor on resist\n",
																2,			4,					{SKILL_ARMOR}, TREE_HEALTHTREE)
GM:AddSkill(SKILL_REGENERATOR, "Regenerator", GOOD.."Regenerate 1 health every 6s when below 60% health\n"..BAD.."-6 maximum health",
																-5,			-2,					{}, TREE_HEALTHTREE)
GM:AddSkill(SKILL_ARMOR, "Armor", GOOD.."Regenerate 1 armor every 6 seconds up to your maximum armor\nArmor absorbs 80% of all damage sources excluding fall damage\nBase armor maximum is 40\n"..BAD.."-15 maximum health",
																2,			2,					{SKILL_CIRCULATION, SKILL_D_HEMOPHILIA}, TREE_HEALTHTREE)
...
GM:AddSkill(SKILL_CIRCULATION, "Circulation", GOOD.."+1 maximum armor",
																4,			4,					{SKILL_SANGUINE}, TREE_HEALTHTREE)
GM:AddSkill(SKILL_SANGUINE, "Sanguine", GOOD.."+9 maximum armor\n"..BAD.."-7 maximum health",
																6,			2,					{}, TREE_HEALTHTREE)
-- Speed Tree
...
GM:AddSkill(SKILL_D_WIDELOAD, "Debuff: Wide Load", GOOD.."+20 starting Worth\n"..GOOD.."-5% resupply delay\n"..BAD.."Phasing speed limited to 1 for the first 6 seconds of phasing",
																1,			1,					{}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_U_CORRUPTEDFRAGMENT, "Placeholder", GOOD.."This skill does nothing",
																-2,			2,					{}, TREE_SPEEDTREE)
...
GM:AddSkill(SKILL_ROBUST, "Robust", GOOD.."-6% movement speed reduction with heavy weapons",
																5,			-5,					{}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_CARDIOTONIC, "Cardiotonic", GOOD.."Sprint while draining 1 armor per 0.5 seconds\n"..GOOD.."+40 movement speed while sprinting\n"..BAD.."-15 movement speed",
																-6,			-4,					{}, TREE_SPEEDTREE)
...
GM:AddSkill(SKILL_U_MEDICCLOUD, "Placeholder", GOOD.."This skill does nothing",
...
GM:AddSkill(SKILL_U_STRENGTHSHOT, "Placeholder", GOOD.."This skill does nothing",
...
GM:AddSkill(SKILL_WORTHINESS2, "Worthiness II", GOOD.."+5 starting worth\n"..BAD.."-3 starting points",
																4,			0,					{}, TREE_MELEETREE)
GM:AddSkill(SKILL_BATTLER1, "Battler I", GOOD.."-2% melee swing impact delay",
																-6,			-6,					{SKILL_BATTLER2, SKILL_NONE}, TREE_MELEETREE)
GM:AddSkill(SKILL_BATTLER2, "Battler II", GOOD.."-3% melee swing impact delay",
																-6,			-4,					{SKILL_BATTLER3, SKILL_LIGHTWEIGHT}, TREE_MELEETREE)
GM:AddSkill(SKILL_BATTLER3, "Battler III", GOOD.."-4% melee swing impact delay",
																-4,			-2,					{SKILL_BATTLER4, SKILL_LANKY}, TREE_MELEETREE)
GM:AddSkill(SKILL_BATTLER4, "Battler IV", GOOD.."-5% melee swing impact delay",
																-2,			0,					{SKILL_BATTLER5, SKILL_MASTERCHEF, SKILL_D_CLUMSY}, TREE_MELEETREE)
GM:AddSkill(SKILL_BATTLER5, "Battler V", GOOD.."-6% melee swing impact delay",
...
GM:SetSkillModifierFunction(SKILLMOD_ARMOR_GAIN_MUL, GM:MkGenericMod("ArmorGainMul"))

GM:SetSkillModifierFunction(SKILLMOD_MELEE_DAMAGE_TO_ARMOR_MUL, function(pl, amount)
	pl.MeleeDamageToArmorMul = math.Clamp(amount, 0, 1000.0)
end)
...
GM:AddSkillModifier(SKILL_CIRCULATION, SKILLMOD_ARMOR, 1)
GM:AddSkillModifier(SKILL_SANGUINE, SKILLMOD_ARMOR, 9)
...
GM:AddSkillModifier(SKILL_SURGEON3, SKILLMOD_MEDKIT_COOLDOWN_MUL, -0.1)
...
GM:AddSkillModifier(SKILL_BATTLER1, SKILLMOD_MELEE_SWING_DELAY_MUL, -0.02)

GM:AddSkillModifier(SKILL_BATTLER2, SKILLMOD_MELEE_SWING_DELAY_MUL, -0.03)

GM:AddSkillModifier(SKILL_BATTLER3, SKILLMOD_MELEE_SWING_DELAY_MUL, -0.04)

GM:AddSkillModifier(SKILL_BATTLER4, SKILLMOD_MELEE_SWING_DELAY_MUL, -0.05)

GM:AddSkillModifier(SKILL_BATTLER5, SKILLMOD_MELEE_SWING_DELAY_MUL, -0.06)
...
GM:AddSkillModifier(SKILL_ARMOR, SKILLMOD_HEALTH, -15)
...
GM:AddSkillModifier(SKILL_CARDIOTONIC, SKILLMOD_SPEED, -15)
