...
trinket, trinketwep = GM:AddTrinket("Armor Transfusion Pack", "armorpack", false, hpveles, hpweles, 2, "Generates 20 armor if health falls bellow 50%\nConsumes itself on activation", nil, 15)
trinketwep.PermitDismantle = true

trinket, trinketwep = GM:AddTrinket("Armor Package", "cardpackagei", false, hpveles, hpweles, 2, "+5 maximum armor")
GM:AddSkillModifier(trinket, SKILLMOD_ARMOR, 5)
trinketwep.PermitDismantle = true

GM:AddSkillModifier(GM:AddTrinket("Armor Bank", "cardpackageii", false, hpveles, hpweles, 4, "+15 maximum armor"), SKILLMOD_ARMOR, 15)
...
GM:AddSkillModifier(GM:AddTrinket("Hemo-Adrenal Converter I", "hemoadrenali", false, mveles, mweles, nil, "+1% melee damage converted to armor"), SKILLMOD_MELEE_DAMAGE_TO_ARMOR_MUL, 0.01)

GM:AddSkillModifier(GM:AddTrinket("Hemo-Adrenaline Amplifier", "hemoadrenalii", false, mveles, mweles, 3, "+1% melee damage converted to armor"), SKILLMOD_MELEE_DAMAGE_TO_ARMOR_MUL, 0.01)

GM:AddSkillModifier(GM:AddTrinket("Hemo-Adrenal Converter II", "hemoadrenaliii", false, mveles, mweles, 4, "+1% melee damage converted to armor."), SKILLMOD_MELEE_DAMAGE_TO_ARMOR_MUL, 0.01)

GM:AddSkillModifier(GM:AddTrinket("Power Gauntlet", "powergauntlet", false, mveles, mweles, 3, "Charges your melee damage up to +20% with each hit\nMissing resets damage"), SKILLMOD_MELEE_POWERATTACK_MUL, 0.20)

GM:AddTrinket("Finesse Kit", "sharpkit", false, mveles, mweles, 2, "Deal up to +32% melee damage to slowed zombies")

GM:AddSkillModifier(GM:AddTrinket("Sharp Stone", "sharpstone", false, mveles, mweles, 3, "+2% melee damage"), SKILLMOD_MELEE_DAMAGE_MUL, 0.02)
