...
function GM:OnPlayerHitGround(pl, inwater, hitfloater, speed)
	if inwater or GAMEMODE.ZombieEscape then return true end
...
function GM:IsSpecialPerson(pl, image)
	...
	if pl:SteamID() == "STEAM_0:0:105668971" then
		img = "icon16/color_wheel.png"
		tooltip = "Owner"

	elseif pl:IsUserGroup("hadmin") then
		img = "icon16/shield_add.png"
		tooltip = "Head Administrator"

	elseif pl:IsUserGroup("xadmin") then
		img = "icon16/shield_add.png"
		tooltip = "Administrator"

	elseif pl:IsUserGroup("smod") then
		img = "icon16/shield.png"
		tooltip = "Senior Moderator"

	elseif pl:IsUserGroup("mod") then
		img = "icon16/shield.png"
		tooltip = "Moderator"

	elseif pl:IsUserGroup("tmod") then
		img = "icon16/shield_delete.png"
		tooltip = "Trial Moderator"

	elseif pl:IsUserGroup("contributor") then
		img = "icon16/application_xp_terminal.png"
		tooltip = "Contributor"

	elseif pl:IsUserGroup("tester") then
		img = "icon16/cog.png"
		tooltip = "Tester"

	elseif pl:IsUserGroup("serverbooster") then
		img = "icon16/flag_pink.png"
	...
	elseif pl:IsUserGroup("user") then
		img = "icon16/user.png"
		tooltip = "User"
	end
...
hook.Add("EntityKeyValue", "ZS.FixKeyValues", function(ent, k, v)
	ent.FixedKeyValues = ent.FixedKeyValues or {}
	ent.FixedKeyValues[k] = v
end)