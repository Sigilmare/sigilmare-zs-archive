...
hook.Add( "PlayerCanPickupWeapon", "RestrictMapWeapons", function( ply, wep )
	...
	if wep:GetClass() == "weapon_elite" then
		if ply:GetZSLevel() < 10 then
			return false
		end
	end
...
--Mako v5 materia translations
GM.MateriaButtonTranslations = {}
GM.MateriaButtonTranslations['magia_rayo'] = "Electro"
GM.MateriaButtonTranslations['magia_fuego'] = "Fire"
GM.MateriaButtonTranslations['magia_cura'] = "Heal"
GM.MateriaButtonTranslations['magia_viento'] = "Wind"
GM.MateriaButtonTranslations['magia_tierra'] = "Earth"
GM.MateriaButtonTranslations['magia_hielo'] = "Ice"
GM.MateriaButtonTranslations['magia_gravedad'] = "Gravity"
GM.MateriaButtonTranslations['magia_ultima'] = "Ultima"