...
killicon.Add("weapon_zs_crygasgrenade", "zombiesurvival/killicons/weapon_zs_corgasgrenade2", Color(0, 150, 150))
killicon.Add("projectile_crygasgrenade", "zombiesurvival/killicons/weapon_zs_corgasgrenade2", Color(0, 150, 150))
killicon.Add("weapon_zs_bloodshotbomb", "zombiesurvival/killicons/weapon_zs_corgasgrenade2", Color(100, 255, 255))
...
killicon.Add("weapon_zs_direzombie", 			"zombiesurvival/killicons/zombie", Color(168, 58, 58))
...
killicon.Add("weapon_zs_eradicator", 			"zombiesurvival/killicons/poisonzombie", Color(0, 0, 0))
...
killicon.Add("weapon_zs_skeletalrioter", 		"sigilmare/killicons/zombie/boss/skeletal_rioter")
...
-- Tier 1
killicon.Add("weapon_zs_battleaxe",				"sigilmare/killicons/guns/tier1/weapon_zs_battleaxe.png")
killicon.Add("weapon_zs_zebattleaxe",			"sigilmare/killicons/guns/tier1/weapon_zs_battleaxe.png")
killicon.Add("weapon_zs_blaster", 				"sigilmare/killicons/guns/tier1/weapon_zs_blaster.png")
killicon.Add("weapon_zs_crackler", 				"sigilmare/killicons/guns/tier1/weapon_zs_crackler.png")
killicon.Add("weapon_zs_minelayer", 			"sigilmare/killicons/guns/tier1/weapon_zs_minelayer.png")
killicon.Add("weapon_zs_owens", 				"sigilmare/killicons/guns/tier1/weapon_zs_owens.png")
killicon.Add("weapon_zs_peashooter", 			"sigilmare/killicons/guns/tier1/weapon_zs_peashooter.png")
killicon.Add("weapon_zs_powerizer", 			"sigilmare/killicons/guns/tier1/weapon_zs_powerizer.png")
killicon.Add("weapon_zs_redeemers", 			"sigilmare/killicons/guns/tier1/weapon_zs_redeemers.png")
killicon.Add("weapon_zs_slinger", 				"sigilmare/killicons/guns/tier1/weapon_zs_slinger.png")
killicon.Add("weapon_zs_stubber", 				"sigilmare/killicons/guns/tier1/weapon_zs_stubber.png")
killicon.Add("weapon_zs_zestubber", 			"sigilmare/killicons/guns/tier1/weapon_zs_stubber.png")
killicon.Add("weapon_zs_tosser", 				"sigilmare/killicons/guns/tier1/weapon_zs_tosser.png")
killicon.Add("weapon_zs_z9000", 				"sigilmare/killicons/guns/tier1/weapon_zs_z9000.png")

killicon.Add("weapon_zs_axe", 					"sigilmare/killicons/melee/tier1/weapon_zs_axe.png")
killicon.Add("weapon_zs_crowbar", 				"sigilmare/killicons/melee/tier1/weapon_zs_crowbar.png")
killicon.Add("weapon_zs_fryingpan", 			"sigilmare/killicons/melee/tier1/weapon_zs_fryingpan.png")
killicon.Add("weapon_zs_hook", 					"sigilmare/killicons/melee/tier1/weapon_zs_hook.png")
killicon.Add("prop_meathook", 					"sigilmare/killicons/melee/tier1/weapon_zs_hook.png")
killicon.Add("weapon_zs_ladel", 				"sigilmare/killicons/melee/tier1/weapon_zs_ladel.png")
killicon.Add("weapon_zs_pipe", 					"sigilmare/killicons/melee/tier1/weapon_zs_pipe.png")
killicon.Add("weapon_zs_plank", 				"sigilmare/killicons/melee/tier1/weapon_zs_plank.png")
killicon.Add("weapon_zs_pot", 					"sigilmare/killicons/melee/tier1/weapon_zs_pot.png")
killicon.Add("weapon_zs_stunbaton", 			"sigilmare/killicons/melee/tier1/weapon_zs_stunbaton.png")
killicon.Add("weapon_zs_swissarmyknife", 		"sigilmare/killicons/melee/tier1/weapon_zs_swissarmyknife.png")
killicon.Add("weapon_zs_zeknife",				"sigilmare/killicons/melee/tier1/weapon_zs_swissarmyknife.png")

-- Tier 2
killicon.Add("weapon_zs_amigo", 				"sigilmare/killicons/guns/tier2/weapon_zs_amigo.png")
killicon.Add("weapon_zs_zeamigo", 				"sigilmare/killicons/guns/tier2/weapon_zs_amigo.png")
killicon.Add("weapon_zs_annabelle", 			"sigilmare/killicons/guns/tier2/weapon_zs_annabelle.png")
killicon.Add("weapon_zs_eraser", 				"sigilmare/killicons/guns/tier2/weapon_zs_eraser.png")
killicon.Add("weapon_zs_zeeraser", 				"sigilmare/killicons/guns/tier2/weapon_zs_eraser.png")
killicon.Add("weapon_zs_glock3", 				"sigilmare/killicons/guns/tier2/weapon_zs_glock3.png")
killicon.Add("weapon_zs_zeglock", 				"sigilmare/killicons/guns/tier2/weapon_zs_glock3.png")
killicon.Add("weapon_zs_magnum", 				"sigilmare/killicons/guns/tier2/weapon_zs_magnum.png")
killicon.Add("weapon_zs_overlord", 				"sigilmare/killicons/guns/tier2/weapon_zs_overlord.png")
killicon.Add("weapon_zs_spreadshot", 			"sigilmare/killicons/guns/tier2/weapon_zs_spreadshot.png")
killicon.Add("weapon_zs_uzi", 					"sigilmare/killicons/guns/tier2/weapon_zs_uzi.png")

killicon.Add("weapon_zs_harpoon", 				"sigilmare/killicons/melee/tier2/weapon_zs_harpoon.png")
killicon.Add("weapon_zs_harpoon_te", 			"sigilmare/killicons/melee/tier2/weapon_zs_harpoon.png")
killicon.Add("prop_harpoon", 					"sigilmare/killicons/melee/tier2/weapon_zs_harpoon.png")
killicon.Add("projectile_harpoon", 				"sigilmare/killicons/melee/tier2/weapon_zs_harpoon.png")
killicon.Add("projectile_harpoon_te", 			"sigilmare/killicons/melee/tier2/weapon_zs_harpoon.png")
killicon.Add("weapon_zs_pushbroom", 			"sigilmare/killicons/melee/tier2/weapon_zs_pushbroom.png")
killicon.Add("weapon_zs_shovel", 				"sigilmare/killicons/melee/tier2/weapon_zs_shovel.png")
killicon.Add("weapon_zs_sledgehammer", 			"sigilmare/killicons/melee/tier2/weapon_zs_sledgehammer.png")

-- Tier 3
killicon.Add("weapon_zs_akbar", 				"sigilmare/killicons/guns/tier3/weapon_zs_akbar.png")
killicon.Add("weapon_zs_zeakbar", 				"sigilmare/killicons/guns/tier3/weapon_zs_akbar.png")
killicon.Add("weapon_zs_deagle", 				"sigilmare/killicons/guns/tier3/weapon_zs_deagle.png")
killicon.Add("weapon_zs_zedeagle", 				"sigilmare/killicons/guns/tier3/weapon_zs_deagle.png")
killicon.Add("weapon_zs_ender", 				"sigilmare/killicons/guns/tier3/weapon_zs_ender.png")
killicon.Add("weapon_zs_hunter", 				"sigilmare/killicons/guns/tier3/weapon_zs_hunter.png")
killicon.Add("weapon_zs_pollutor", 				"sigilmare/killicons/guns/tier3/weapon_zs_pollutor.png")
killicon.Add("projectile_biorifle", 			"sigilmare/killicons/guns/tier3/weapon_zs_pollutor.png")
killicon.Add("weapon_zs_silencer", 				"sigilmare/killicons/guns/tier3/weapon_zs_silencer.png")
killicon.Add("weapon_zs_zesilencer", 			"sigilmare/killicons/guns/tier3/weapon_zs_silencer.png")
killicon.Add("weapon_zs_smg", 					"sigilmare/killicons/guns/tier3/weapon_zs_smg.png")
killicon.Add("weapon_zs_zesmg", 				"sigilmare/killicons/guns/tier3/weapon_zs_smg.png")
killicon.Add("weapon_zs_tempest", 				"sigilmare/killicons/guns/tier3/weapon_zs_tempest.png")
killicon.Add("weapon_zs_zetempest", 			"sigilmare/killicons/guns/tier3/weapon_zs_tempest.png")

killicon.Add("weapon_zs_executioner", 			"sigilmare/killicons/melee/tier3/weapon_zs_executioner.png")
killicon.Add("weapon_zs_longsword", 			"sigilmare/killicons/melee/tier3/weapon_zs_longsword.png")
killicon.Add("weapon_zs_meattenderizer", 		"sigilmare/killicons/melee/tier3/weapon_zs_meattenderizer.png")
killicon.Add("weapon_zs_rebarmace", 			"sigilmare/killicons/melee/tier3/weapon_zs_rebarmace.png")

-- Tier 4
killicon.Add("weapon_zs_bulletstorm", 			"sigilmare/killicons/guns/tier4/weapon_zs_bulletstorm.png")
killicon.Add("weapon_zs_zebulletstorm", 		"sigilmare/killicons/guns/tier4/weapon_zs_bulletstorm.png")
killicon.Add("weapon_zs_inferno", 				"sigilmare/killicons/guns/tier4/weapon_zs_inferno.png")
killicon.Add("weapon_zs_zeinferno", 			"sigilmare/killicons/guns/tier4/weapon_zs_inferno.png")
killicon.Add("weapon_zs_m4", 					"sigilmare/killicons/guns/tier4/weapon_zs_m4.png")
killicon.Add("weapon_zs_zem4", 					"sigilmare/killicons/guns/tier4/weapon_zs_m4.png")
killicon.Add("weapon_zs_quicksilver", 			"sigilmare/killicons/guns/tier4/weapon_zs_quicksilver.png")
killicon.Add("weapon_zs_zequicksilver", 		"sigilmare/killicons/guns/tier4/weapon_zs_quicksilver.png")
killicon.Add("weapon_zs_reaper", 				"sigilmare/killicons/guns/tier4/weapon_zs_reaper.png")
killicon.Add("weapon_zs_sweepershotgun", 		"sigilmare/killicons/guns/tier4/weapon_zs_sweepershotgun.png")
killicon.Add("weapon_zs_zesweeper", 			"sigilmare/killicons/guns/tier4/weapon_zs_sweepershotgun.png")

killicon.Add("weapon_zs_graveshovel", 			"sigilmare/killicons/melee/tier4/weapon_zs_graveshovel.png")
killicon.Add("weapon_zs_scythe", 				"sigilmare/killicons/melee/tier4/weapon_zs_scythe.png")

-- Tier 5
killicon.Add("weapon_zs_boomstick", 			"sigilmare/killicons/guns/tier5/weapon_zs_boomstick.png")
killicon.Add("weapon_zs_crossbow", 				"sigilmare/killicons/guns/tier5/weapon_zs_crossbow.png")
killicon.Add("projectile_arrow", 				"sigilmare/killicons/guns/tier5/weapon_zs_crossbow.png")
killicon.Add("weapon_zs_juggernaut", 			"sigilmare/killicons/guns/tier5/weapon_zs_juggernaut.png")
killicon.Add("projectile_juggernaut", 			"sigilmare/killicons/guns/tier5/weapon_zs_juggernaut.png")
killicon.Add("weapon_zs_pulserifle", 			"sigilmare/killicons/guns/tier5/weapon_zs_pulserifle.png")

killicon.Add("weapon_zs_frotchet", 				"sigilmare/killicons/melee/tier5/weapon_zs_frotchet.png")

-- Tier 6
killicon.Add("weapon_zs_thrasher", 				"sigilmare/killicons/guns/tier6/weapon_zs_thrasher.png")
killicon.Add("weapon_zs_kg9", 					"sigilmare/killicons/placeholder.png")
killicon.Add("weapon_zs_dualdeagles", 			"sigilmare/killicons/guns/tier6/weapon_zs_dualdeagles.png")

killicon.Add("weapon_zs_windmillblade",			"sigilmare/killicons/melee/tier6/weapon_zs_windmillblade.png")

-- Other
killicon.Add("weapon_zs_tommygun", 				"sigilmare/killicons/guns/weapon_zs_tommygun.png")

killicon.Add("weapon_zs_deathmachine", 			"zombiesurvival/killicons/weapon_zs_bulwark2")
killicon.Add("weapon_zs_sledgehammer_j", 		"sigilmare/killicons/melee/tier2/weapon_zs_sledgehammer.png")
...
net.Receive("zs_pl_kill_self", function(length)
	...
	if victim:IsValid() then
		...
		GAMEMODE:TopNotify("Goodbye, cruel world! ", victim)
	end
end)
...
net.Receive("zs_playerredeemed", function(length)
	...
	if pl:IsValid() then
		if pl != MySelf then
			GAMEMODE:CenterNotify(translate.Format("x_redeemed", pl:Name()), " ", {killicon = "redeem"})
		end
