...
function GM:GetWeaponClassOfQuality(classname, quality, branch)
	return classname.."_"..string.char(97 + (branch or 0))..quality
end
...
function GM:GetDismantleScrap(wtbl, invitem)
	...
	return math.floor((basicvalue * (wtbl.IsMelee and 1 or 1)) / (wtbl.DismantleDiv or dismantlediv))
end

function GM:GetUpgradeScrap(wtbl, qualitychoice)
	local itier = wtbl.Tier

	return math.ceil(self.ScrapVals[itier or 1] * qualitychoice * (wtbl.IsMelee and 1 or 1))
end
