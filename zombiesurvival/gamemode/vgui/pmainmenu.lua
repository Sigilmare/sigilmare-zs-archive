...
function GM:ShowHelp()
	...
	but:SetText("Active Skill Modifiers")
	but:SetTall(buttonhei)
	but:DockMargin(0, 0, 0, 12)
	but:DockPadding(0, 12, 0, 12)
	but:Dock(TOP)
	but.DoClick = function() MakepActiveSkillMods() end
	...
	but:DockPadding(0, 12, 0, 12)
	but:Dock(TOP)
	but.DoClick = function() MakepAchievements() end
	...
	but:DockPadding(0, 12, 0, 12)
	but:Dock(TOP)
	but.DoClick = function() StatsMenuV1() end
