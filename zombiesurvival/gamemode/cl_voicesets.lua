...
VoiceSets[VOICESET_ZOMBINE] = {
	[VOICELINE_GIVEAMMO] = {
		Sound("sigilmare/sfx/zombine/zombine_readygrenade1.wav"),
		Sound("sigilmare/sfx/zombine/zombine_readygrenade2.wav")
	},
	[VOICELINE_PAIN_LIGHT] = {
		Sound("sigilmare/sfx/zombine/zombine_pain2.wav")
	},
	[VOICELINE_PAIN_MED] = {
		Sound("sigilmare/sfx/zombine/zombine_pain3.wav")
	},
	[VOICELINE_PAIN_HEAVY] = {
		Sound("sigilmare/sfx/zombine/zombine_pain1.wav"),
		Sound("sigilmare/sfx/zombine/zombine_pain4.wav")
	},
	[VOICELINE_DEATH] = {
		Sound("sigilmare/sfx/zombine/zombine_die1.wav"),
		Sound("sigilmare/sfx/zombine/zombine_die2.wav")
	},
	[VOICELINE_EYEPAIN] = {
		Sound("sigilmare/sfx/zombine/zombine_pain4.wav")
	}
...
VoiceSets[VOICESET_ROASTER] = {
	[VOICELINE_GIVEAMMO] = {
		Sound("sigilmare/hellsgamers/roaster/roaster_pain1.ogg"),
        Sound("sigilmare/hellsgamers/roaster/roaster_pain2.ogg"),
        Sound("sigilmare/hellsgamers/roaster/roaster_pain3.ogg"),
	},
	[VOICELINE_PAIN_LIGHT] = {
		Sound("sigilmare/hellsgamers/roaster/roaster_pain1.ogg"),
        Sound("sigilmare/hellsgamers/roaster/roaster_pain2.ogg"),
	...
	[VOICELINE_DEATH] = {
		Sound("sigilmare/hellsgamers/roaster/roaster_die1.ogg"),
        Sound("sigilmare/hellsgamers/roaster/roaster_die2.ogg"),
        Sound("sigilmare/hellsgamers/roaster/roaster_die3.ogg"),
		Sound("sigilmare/hellsgamers/roaster/roaster_die4.ogg"),
		Sound("sigilmare/hellsgamers/roaster/roaster_die5.ogg"),
	},
	[VOICELINE_EYEPAIN] = {
		Sound("sigilmare/hellsgamers/roaster/roaster_die1.ogg"),
        Sound("sigilmare/hellsgamers/roaster/roaster_die2.ogg"),
